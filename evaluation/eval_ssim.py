...
from metric_functions.ssim import get_SSIM
...
def main():
    ...
    save_path = os.path.join(result_root_path, "ssim.json")
        ...
        for model_name in model_list:
            ...
            for sub_folder in sub_list:
                ...
                for img in image_list:
                    ...
                    ssim += get_SSIM(gt_path, img_path, full=False, win_size=51).item()
                model_result[sub_folder] = ssim/len(image_list)
